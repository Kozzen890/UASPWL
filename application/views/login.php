...
<html lang="en">
  <head>
    ...
    <title>Crypto v1.0 | Login Page</title>
                  ...
                  <div class="col-lg">
                    <div class="p-5">
                      <div class="text-center">
                        <h4 class="text-dark mb-4">Form Login</h4>
                      </div>
                      <form action="" method="post" class="user">
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control mt-1" name="password" placeholder="Masukkan Password...">
                        </div>
                        <button type="submit" class="btn btn-primary btn-user btn-block mt-3">Login</button>
                      </form>
                      <hr>
											<a href="<?= base_url("Login/register"); ?>" class="text-primary">Need an Account ? Register</a>
                    </div>
                  </div>
                </div>
              </div>
